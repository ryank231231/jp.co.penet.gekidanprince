...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    return (paramFloat1 > 0.0F) ? constrain(paramFloat1 * paramFloat3, paramFloat2, f2) : -constrain(-paramFloat1 * paramFloat3, paramFloat2, f2);
  }
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\v4\widget\AutoScrollHelper.class
