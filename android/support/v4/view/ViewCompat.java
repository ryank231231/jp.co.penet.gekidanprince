...
public class ViewCompat {
  ...
  static class ViewCompatApi26Impl extends ViewCompatApi24Impl {
    ...
    public int getImportantForAutofill(@NonNull View param1View) {
    ...
    public boolean isImportantForAutofill(@NonNull View param1View) {
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\v4\view\ViewCompat.class
