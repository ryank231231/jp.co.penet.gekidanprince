...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject) {
    if (paramObject != null && Build.VERSION.SDK_INT >= 21) {
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        Bundle bundle = PlaybackStateCompatApi22.getExtras(paramObject);
      } else {
        list = null;
      } 
      PlaybackStateCompat playbackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), (List<CustomAction>)playbackStateCompat, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), (Bundle)list);
  ...
  public Object getPlaybackState() {
    if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
      ...
      if (list != null) {
        list = new ArrayList<CustomAction>(list.size());
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        this.mStateObj = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)list, this.mActiveItemId, this.mExtras);
      } else {
        this.mStateObj = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)list, this.mActiveItemId);
      } 
    } 
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\v4\media\session\PlaybackStateCompat.class
