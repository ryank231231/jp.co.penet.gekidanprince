    ...
    private class StubApi21 implements MediaSessionCompatApi21.Callback {
      public void onCommand(String param2String, Bundle param2Bundle, ResultReceiver param2ResultReceiver) {
        try {
          ...
          } else if (iBinder1.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
          ...
          } else if (iBinder1.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
            param2Bundle.setClassLoader(MediaDescriptionCompat.class.getClassLoader());
      ...
      public ParcelableVolumeInfo getVolumeAttributes() {
        synchronized (MediaSessionCompat.MediaSessionImplBase.this.mLock) {
          ...
          if (i == 2) {
            ...
            int n = volumeProviderCompat.getCurrentVolume();
            m = k;
            k = n;
          } else {
            m = MediaSessionCompat.MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(j);
            k = MediaSessionCompat.MediaSessionImplBase.this.mAudioManager.getStreamVolume(j);
            b = 2;
          } 
    ...
    public ParcelableVolumeInfo getVolumeAttributes() {
      synchronized (this.this$0.mLock) {
        ...
        if (i == 2) {
          ...
          m = this.this$0.mAudioManager.getStreamMaxVolume(j);
          k = this.this$0.mAudioManager.getStreamVolume(j);
          b = 2;
        } 
        return new ParcelableVolumeInfo(i, j, b, m, k);
      } 
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
