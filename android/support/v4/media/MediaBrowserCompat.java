                ...
                if (!MediaBrowserCompat.DEBUG || MediaBrowserCompat.MediaBrowserImplBase.this.mServiceConnection == null) {
                  if (MediaBrowserCompat.MediaBrowserImplBase.this.mServiceBinderWrapper == null) {
                    if (MediaBrowserCompat.MediaBrowserImplBase.this.mCallbacksMessenger == null) {
                      ...
                      boolean bool1 = false;
                      try {
                        bool2 = MediaBrowserCompat.MediaBrowserImplBase.this.mContext.bindService(intent, MediaBrowserCompat.MediaBrowserImplBase.this.mServiceConnection, 1);
      ...
      if (!MediaBrowserCompat.DEBUG || this.this$0.mServiceConnection == null) {
        if (this.this$0.mServiceBinderWrapper == null) {
          if (this.this$0.mCallbacksMessenger == null) {
            ...
            boolean bool1 = false;
            try {
              bool2 = this.this$0.mContext.bindService(intent, this.this$0.mServiceConnection, 1);
            } catch (Exception exception) {
              StringBuilder stringBuilder3 = new StringBuilder();
              stringBuilder3.append("Failed binding to service ");
      ...
      public void onChildrenLoaded(@NonNull String param2String, List<?> param2List) {
        ...
        if (subscription == null) {
          ...
          for (byte b = 0; b < param2List.size(); b++) {
            ...
            if (bundle == null) {
              MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(param2String, list);
            } else {
              MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(param2String, applyOptions(list, bundle), bundle);
            } 
          } 
        } 
      }
    ...
    public void onChildrenLoaded(@NonNull String param1String, List<?> param1List) {
      ...
      if (subscription == null) {
        ...
        for (byte b = 0; b < param1List.size(); b++) {
          Bundle bundle = list1.get(b);
          if (bundle == null) {
            this.this$0.onChildrenLoaded(param1String, list);
          } else {
            this.this$0.onChildrenLoaded(param1String, applyOptions(list, bundle), bundle);
          } 
        } 
      } 
    }
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserCompat.class
