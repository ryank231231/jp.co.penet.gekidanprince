...
public class ResolutionAnchor extends ResolutionNode {
  ...
  void addResolvedValue(LinearSystem paramLinearSystem) {
    ...
    if (resolutionAnchor == null) {
      ...
      paramLinearSystem.addEquality(solverVariable, paramLinearSystem.createObjectVariable(resolutionAnchor.myAnchor), (int)this.resolvedOffset, 6);
    } 
  }
      ...
      if (resolutionAnchor != null && resolutionAnchor.state == 1) {
        ...
        if (resolutionAnchor != null) {
          ...
          if (resolutionAnchor != null && resolutionAnchor.state == 1) {
            ...
            resolutionAnchor = this.opposite;
            ResolutionAnchor resolutionAnchor1 = resolutionAnchor.target;
            resolutionAnchor.resolvedTarget = resolutionAnchor1.resolvedTarget;
            resolutionAnchor2.resolvedOffset += this.offset;
            resolutionAnchor1.resolvedOffset += resolutionAnchor.offset;
            didResolve();
            this.opposite.didResolve();
            return;
          } 
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\constraint\solver\widgets\ResolutionAnchor.class
