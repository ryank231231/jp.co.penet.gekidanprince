...
public class WidgetContainer extends ConstraintWidget {
  ...
  public ConstraintWidget findWidget(float paramFloat1, float paramFloat2) {
    ...
    for (constraintWidget2 = constraintWidget1; i < j; constraintWidget2 = constraintWidget1) {
      ...
      if (constraintWidget instanceof WidgetContainer) {
        ...
        m = constraintWidget.getDrawY();
        k = constraintWidget.getWidth();
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\constraint\solver\widgets\WidgetContainer.class
