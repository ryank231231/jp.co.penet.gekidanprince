...
public class AnimatorInflaterCompat {
  ...
  private static PropertyValuesHolder getPVH(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString) {
    ...
    //   471: iload_3
    //   472: fconst_0
    //   473: invokevirtual getDimension : (IF)F
    //   476: fstore #15
    //   478: goto -> 489
    //   481: aload_0
    //   482: iload_3
    //   483: fconst_0
    //   484: invokevirtual getFloat : (IF)F
    //   487: fstore #15
    //   489: aload #4
    //   491: iconst_1
    //   492: newarray float
    ...
    //   496: fload #15
    //   498: fastore
    //   499: invokestatic ofFloat : (Ljava/lang/String;[F)Landroid/animation/PropertyValuesHolder;
    //   502: astore #5
    //   504: goto -> 704
    //   507: iload #6
    //   509: ifeq -> 639
        ...
        while (true) {
          ...
          if (b < i) {
            ...
            if (k < arrayList.size()) {
              paramFloat = f;
              m = j;
              if (f > ((Float)arrayList.get(k)).floatValue()) {
                paramFloat = f - ((Float)arrayList.get(k)).floatValue();
...
/* Location:              Y:\classes-dex2jar.jar!\android\support\graphics\drawable\AnimatorInflaterCompat.class
