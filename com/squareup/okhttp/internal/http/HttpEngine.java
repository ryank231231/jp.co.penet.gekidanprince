...
public final class HttpEngine {
  ...
  private Response unzip(Response paramResponse) throws IOException {
    ...
    return paramResponse.newBuilder().headers(headers).body(new RealResponseBody(headers, Okio.buffer((Source)gzipSource))).build();
  }
  ...
  public Request followUpRequest() throws IOException {
    if (this.userResponse != null) {
      ...
      if (realConnection != null) {
        Proxy proxy = realConnection.getProxy();
      } else {
      ...
      if (i != 401) {
        if (i != 407) {
          ...
          if (str1 == null)
            return null; 
          httpUrl = this.userRequest.httpUrl().resolve(str1);
          if (httpUrl == null)
            return null; 
        ...
        if (httpUrl.type() != Proxy.Type.HTTP)
          throw new ProtocolException("Received HTTP_PROXY_AUTH (407) code while not using proxy"); 
      } 
      return OkHeaders.processAuthHeader(this.client.getAuthenticator(), this.userResponse, (Proxy)httpUrl);
    } 
...
/* Location:              Y:\classes2-dex2jar.jar!\com\squareup\okhttp\internal\http\HttpEngine.class
