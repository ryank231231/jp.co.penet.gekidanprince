...
public final class Control extends GeneratedMessageLite<Control, Control.Builder> implements ControlOrBuilder {
  ...
  public static Builder newBuilder(Control paramControl) {
    return (Builder)((Builder)DEFAULT_INSTANCE.toBuilder()).mergeFrom(paramControl);
  }
  
  public static Control parseDelimitedFrom(InputStream paramInputStream) throws IOException {
    return (Control)parseDelimitedFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  ...
  public static Control parseDelimitedFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return (Control)parseDelimitedFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static Control parseFrom(ByteString paramByteString) throws InvalidProtocolBufferException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramByteString);
  }
  ...
  public static Control parseFrom(ByteString paramByteString, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramByteString, paramExtensionRegistryLite);
  }
  
  public static Control parseFrom(CodedInputStream paramCodedInputStream) throws IOException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramCodedInputStream);
  }
  ...
  public static Control parseFrom(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramCodedInputStream, paramExtensionRegistryLite);
  }
  
  public static Control parseFrom(InputStream paramInputStream) throws IOException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  ...
  public static Control parseFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static Control parseFrom(byte[] paramArrayOfbyte) throws InvalidProtocolBufferException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte);
  }
  ...
  public static Control parseFrom(byte[] paramArrayOfbyte, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return (Control)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte, paramExtensionRegistryLite);
  }
  ...
  private void setEnvironment(String paramString) {
    if (paramString != null) {
      this.environment_ = paramString;
      return;
    } 
    throw new NullPointerException();
  }
  
  private void setEnvironmentBytes(ByteString paramByteString) {
    if (paramByteString != null) {
      checkByteStringIsUtf8(paramByteString);
      this.environment_ = paramByteString.toStringUtf8();
      return;
    } 
    throw new NullPointerException();
  }
  ...
  protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke paramMethodToInvoke, Object paramObject1, Object paramObject2) {
    // Byte code:
    //   0: getstatic com/google/api/Control$1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke : [I
    //   3: aload_1
    ...
    //   63: athrow
    //   64: getstatic com/google/api/Control.PARSER : Lcom/google/protobuf/Parser;
    //   67: ifnonnull -> 106
    //   70: ldc com/google/api/Control
    //   72: monitorenter
    //   73: getstatic com/google/api/Control.PARSER : Lcom/google/protobuf/Parser;
    //   76: ifnonnull -> 94
    //   79: new com/google/protobuf/GeneratedMessageLite$DefaultInstanceBasedParser
    //   82: astore_1
    //   83: aload_1
    //   84: getstatic com/google/api/Control.DEFAULT_INSTANCE : Lcom/google/api/Control;
    //   87: invokespecial <init> : (Lcom/google/protobuf/GeneratedMessageLite;)V
    //   90: aload_1
    //   91: putstatic com/google/api/Control.PARSER : Lcom/google/protobuf/Parser;
    //   94: ldc com/google/api/Control
    //   96: monitorexit
    //   97: goto -> 106
    //   100: astore_1
    //   101: ldc com/google/api/Control
    //   103: monitorexit
    //   104: aload_1
    //   105: athrow
    //   106: getstatic com/google/api/Control.PARSER : Lcom/google/protobuf/Parser;
    //   109: areturn
    //   110: aload_2
    ...
    //   166: putfield environment_ : Ljava/lang/String;
    //   169: goto -> 123
    //   172: iconst_1
    //   173: istore #4
    //   175: goto -> 123
    ...
    //   226: aload_1
    //   227: athrow
    //   228: getstatic com/google/api/Control.DEFAULT_INSTANCE : Lcom/google/api/Control;
    //   231: areturn
    //   232: aload_2
    //   233: checkcast com/google/protobuf/GeneratedMessageLite$Visitor
    //   236: astore_1
    //   237: aload_3
    //   238: checkcast com/google/api/Control
    //   241: astore_2
    //   242: aload_0
    //   243: aload_1
    //   244: aload_0
    //   245: getfield environment_ : Ljava/lang/String;
    //   248: invokevirtual isEmpty : ()Z
    //   251: iconst_1
    //   252: ixor
    //   253: aload_0
    //   254: getfield environment_ : Ljava/lang/String;
    //   257: iconst_1
    //   258: aload_2
    //   259: getfield environment_ : Ljava/lang/String;
    //   262: invokevirtual isEmpty : ()Z
    //   265: ixor
    //   266: aload_2
    //   267: getfield environment_ : Ljava/lang/String;
    //   270: invokeinterface visitString : (ZLjava/lang/String;ZLjava/lang/String;)Ljava/lang/String;
    //   275: putfield environment_ : Ljava/lang/String;
    ...
    //   282: aload_0
    //   283: areturn
    //   284: new com/google/api/Control$Builder
    //   287: dup
    //   288: aconst_null
    //   289: invokespecial <init> : (Lcom/google/api/Control$1;)V
    //   292: areturn
    //   293: aconst_null
    //   294: areturn
    //   295: getstatic com/google/api/Control.DEFAULT_INSTANCE : Lcom/google/api/Control;
    //   298: areturn
    //   299: new com/google/api/Control
    //   302: dup
  ...
  public void writeTo(CodedOutputStream paramCodedOutputStream) throws IOException {
    if (!this.environment_.isEmpty())
      paramCodedOutputStream.writeString(1, getEnvironment()); 
  }
  ...
  public static final class Builder extends GeneratedMessageLite.Builder<Control, Builder> implements ControlOrBuilder {
    ...
    public Builder setEnvironment(String param1String) {
      copyOnWrite();
      ((Control)this.instance).setEnvironment(param1String);
      return this;
    }
    
    public Builder setEnvironmentBytes(ByteString param1ByteString) {
      copyOnWrite();
      ((Control)this.instance).setEnvironmentBytes(param1ByteString);
      return this;
    }
  }
}
...
/* Location:              Y:\classes-dex2jar.jar!\com\google\api\Control.class
