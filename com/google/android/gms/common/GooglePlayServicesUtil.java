...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
  ...
  public static boolean showErrorDialogFragment(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener) {
    ...
    Dialog dialog = GoogleApiAvailability.zaa((Context)paramActivity, i, DialogRedirect.getInstance(paramFragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent((Context)paramActivity, i, "d"), paramInt2), paramOnCancelListener);
    if (dialog == null)
      return false; 
...
/* Location:              Y:\classes-dex2jar.jar!\com\google\android\gms\common\GooglePlayServicesUtil.class
