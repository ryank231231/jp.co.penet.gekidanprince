...
final class ComparatorOrdering<T> extends Ordering<T> implements Serializable {
  ...
  ComparatorOrdering(Comparator<T> paramComparator) {
    this.comparator = (Comparator<T>)Preconditions.checkNotNull(paramComparator);
  }
...
/* Location:              Y:\classes-dex2jar.jar!\com\google\common\collect\ComparatorOrdering.class
