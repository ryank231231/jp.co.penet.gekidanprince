  ...
  private static Method getPublicMethod(Class<?> paramClass, String paramString, Class[] paramArrayOfClass) {
    ...
    try {
      if ((paramClass.getModifiers() & 0x1) == 0)
        return getPublicMethod(paramClass.getSuperclass(), paramString, paramArrayOfClass); 
...
/* Location:              Y:\classes2-dex2jar.jar!\io\grpc\okhttp\internal\OptionalMethod.class
