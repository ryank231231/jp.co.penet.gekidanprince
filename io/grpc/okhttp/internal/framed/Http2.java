...
public final class Http2 implements Variant {
  ...
  static final class FrameLogger {
        ...
        while (true) {
          ...
          if (b < j) {
            ...
            for (i = 0; i < m; i++) {
              ...
              arrayOfString4[i1] = stringBuilder1.toString();
              ...
              arrayOfString3[i1 | 0x8] = stringBuilder2.toString();
            } 
            b++;
            continue;
          } 
    ...
    static String formatFlags(byte param1Byte1, byte param1Byte2) {
      ...
      //   52: getstatic io/grpc/okhttp/internal/framed/Http2$FrameLogger.FLAGS : [Ljava/lang/String;
      //   55: astore_2
      //   56: iload_1
      //   57: aload_2
      //   58: arraylength
      ...
      //   76: astore_2
      //   77: goto -> 86
      //   80: getstatic io/grpc/okhttp/internal/framed/Http2$FrameLogger.BINARY : [Ljava/lang/String;
      //   83: iload_1
      //   84: aaload
      //   85: astore_2
      //   86: aload_2
      //   87: areturn
      //   88: getstatic io/grpc/okhttp/internal/framed/Http2$FrameLogger.BINARY : [Ljava/lang/String;
      //   91: iload_1
      //   92: aaload
      //   93: areturn
      //   94: getstatic io/grpc/okhttp/internal/framed/Http2$FrameLogger.BINARY : [Ljava/lang/String;
      //   97: iload_1
      //   98: aaload
      //   99: astore_2
      //   100: iload_0
  ...
  static final class Writer implements FrameWriter {
    ...
    public void pushPromise(int param1Int1, int param1Int2, List<Header> param1List) throws IOException {
      ...
      //   6: ifne -> 133
      //   9: aload_0
      //   10: getfield hpackWriter : Lio/grpc/okhttp/internal/framed/Hpack$Writer;
      //   13: aload_3
...
/* Location:              Y:\classes2-dex2jar.jar!\io\grpc\okhttp\internal\framed\Http2.class
