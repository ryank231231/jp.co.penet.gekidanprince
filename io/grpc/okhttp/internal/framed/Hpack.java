...
final class Hpack {
  ...
  static final class Reader {
    ...
    private int dynamicTableIndex(int param1Int) {
      return this.nextDynamicTableIndex + 1 + param1Int;
    }
    ...
    private int evictToRecoverBytes(int param1Int) {
      ...
      if (param1Int > 0) {
        ...
        int j = param1Int;
        param1Int = bool;
        while (i >= this.nextDynamicTableIndex && j > 0) {
        ...
        System.arraycopy(arrayOfHeader, i + 1, arrayOfHeader, i + 1 + param1Int, this.dynamicTableHeaderCount);
        this.nextDynamicTableIndex += param1Int;
        i = param1Int;
      } 
      return i;
    }
    ...
    private void insertIntoDynamicTable(int param1Int, Header param1Header) {
      ...
      if (param1Int == -1) {
        param1Int = this.dynamicTableHeaderCount;
        Header[] arrayOfHeader = this.dynamicTable;
        ...
        param1Int = this.nextDynamicTableIndex;
        this.nextDynamicTableIndex = param1Int - 1;
...
/* Location:              Y:\classes2-dex2jar.jar!\io\grpc\okhttp\internal\framed\Hpack.class
