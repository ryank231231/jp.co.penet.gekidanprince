...
public final class FlowableRefCount<T> extends Flowable<T> {
  ...
  public FlowableRefCount(ConnectableFlowable<T> paramConnectableFlowable) {
    this(paramConnectableFlowable, 1, 0L, TimeUnit.NANOSECONDS, Schedulers.trampoline());
  }
  ...
  void cancel(RefConnection paramRefConnection) {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield connection : Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;
    //   6: ifnonnull -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual timeout : (Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    //   54: aload_0
    //   55: monitorexit
    //   56: return
  ...
  protected void subscribeActual(Subscriber<? super T> paramSubscriber) {
    ...
    //   9: aload_2
    //   10: ifnonnull -> 27
    //   13: new io/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection
    //   16: astore_3
    //   17: aload_3
    //   18: aload_0
    //   19: invokespecial <init> : (Lio/reactivex/internal/operators/flowable/FlowableRefCount;)V
    //   22: aload_0
    //   23: aload_3
    //   24: putfield connection : Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;
    //   27: aload_3
    ...
    //   105: monitorexit
    //   106: aload_0
    //   107: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
    //   110: new io/reactivex/internal/operators/flowable/FlowableRefCount$RefCountSubscriber
    //   113: dup
    //   114: aload_1
    //   115: aload_0
    //   116: aload_3
    //   117: invokespecial <init> : (Lorg/reactivestreams/Subscriber;Lio/reactivex/internal/operators/flowable/FlowableRefCount;Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    //   120: invokevirtual subscribe : (Lio/reactivex/FlowableSubscriber;)V
    //   123: iload #7
    //   125: ifeq -> 136
    //   128: aload_0
    //   129: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
    //   132: aload_3
  ...
  void terminated(RefConnection paramRefConnection) {
    ...
    //   9: aload_0
    //   10: aconst_null
    //   11: putfield connection : Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;
    //   14: aload_1
    ...
    //   30: aload_0
    //   31: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
    //   34: instanceof io/reactivex/disposables/Disposable
    //   37: ifeq -> 52
    //   40: aload_0
    //   41: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
  ...
  void timeout(RefConnection paramRefConnection) {
    ...
    //   11: aload_1
    //   12: aload_0
    //   13: getfield connection : Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;
    //   16: if_acmpne -> 51
    //   19: aload_0
    //   20: aconst_null
    //   21: putfield connection : Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;
    //   24: aload_1
    //   25: invokestatic dispose : (Ljava/util/concurrent/atomic/AtomicReference;)Z
    //   28: pop
    //   29: aload_0
    //   30: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
    //   33: instanceof io/reactivex/disposables/Disposable
    //   36: ifeq -> 51
    //   39: aload_0
    //   40: getfield source : Lio/reactivex/flowables/ConnectableFlowable;
  ...
  static final class RefConnection extends AtomicReference<Disposable> implements Runnable, Consumer<Disposable> {
    ...
    RefConnection(FlowableRefCount<?> param1FlowableRefCount) {
      this.parent = param1FlowableRefCount;
    }
  ...
  static final class RefCountSubscriber<T> extends AtomicBoolean implements FlowableSubscriber<T>, Subscription {
    ...
    RefCountSubscriber(Subscriber<? super T> param1Subscriber, FlowableRefCount<T> param1FlowableRefCount, FlowableRefCount.RefConnection param1RefConnection) {
...
/* Location:              Y:\classes2-dex2jar.jar!\io\reactivex\internal\operators\flowable\FlowableRefCount.class
