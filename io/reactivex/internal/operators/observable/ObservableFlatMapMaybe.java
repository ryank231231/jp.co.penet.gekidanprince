...
public final class ObservableFlatMapMaybe<T, R> extends AbstractObservableWithUpstream<T, R> {
  ...
  protected void subscribeActual(Observer<? super R> paramObserver) {
    this.source.subscribe(new FlatMapMaybeObserver<T, R>(paramObserver, this.mapper, this.delayErrors));
  }
  ...
  static final class FlatMapMaybeObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
    ...
    FlatMapMaybeObserver(Observer<? super R> param1Observer, Function<? super T, ? extends MaybeSource<? extends R>> param1Function, boolean param1Boolean) {
    ...
    final class InnerObserver extends AtomicReference<Disposable> implements MaybeObserver<R>, Disposable {
      ...
      public void onError(Throwable param2Throwable) {
        ObservableFlatMapMaybe.FlatMapMaybeObserver.this.innerError(this, param2Throwable);
      }
      ...
      public void onSuccess(R param2R) {
        ObservableFlatMapMaybe.FlatMapMaybeObserver.this.innerSuccess(this, param2R);
      }
    }
  }
...
/* Location:              Y:\classes2-dex2jar.jar!\io\reactivex\internal\operators\observable\ObservableFlatMapMaybe.class
