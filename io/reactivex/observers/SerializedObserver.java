...
public final class SerializedObserver<T> implements Observer<T>, Disposable {
  ...
  public SerializedObserver(@NonNull Observer<? super T> paramObserver) {
    this(paramObserver, false);
  }
  
  public SerializedObserver(@NonNull Observer<? super T> paramObserver, boolean paramBoolean) {
  ...
  void emitLoop() {
    ...
    //   31: invokevirtual accept : (Lio/reactivex/Observer;)Z
    //   34: ifeq -> 0
    //   37: return
    //   38: astore_1
    //   39: aload_0
  ...
  public void onComplete() {
    ...
    //   73: monitorexit
    //   74: aload_0
    //   75: getfield actual : Lio/reactivex/Observer;
  ...
  public void onError(@NonNull Throwable paramThrowable) {
    ...
    //   124: return
    //   125: aload_0
    //   126: getfield actual : Lio/reactivex/Observer;
    //   129: aload_1
  ...
  public void onNext(@NonNull T paramT) {
    ...
    //   96: monitorexit
    //   97: aload_0
    //   98: getfield actual : Lio/reactivex/Observer;
    //   101: aload_1
...
/* Location:              Y:\classes2-dex2jar.jar!\io\reactivex\observers\SerializedObserver.class
